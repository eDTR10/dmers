          ...
          <div className="ml-5">
            ...
            <ul className="px-2 flex flex-col space-y-2">
              {/* <li className={`flex items-center space-x-2 cursor-pointer p-2 rounded-sm ${
                currentPath === '/bukidnon' ? 'bg-[#1C1D20]' : 'hover:bg-[#1C1D20]'
              }`}>
              ...
              {/* <li className={`flex items-center space-x-2 cursor-pointer p-2 rounded-sm ${
                currentPath === '/lanao-del-norte' ? 'bg-[#1C1D20]' : 'hover:bg-[#1C1D20]'
              }`}>
                <Building2Icon className="text-white" />
                <Link to="/lanao-del-norte" className="text-white">Lanao del Norte</Link>
              </li>
              <li className={`flex items-center space-x-2 cursor-pointer p-2 rounded-sm ${
                currentPath === '/misamis-occidental' ? 'bg-[#1C1D20]' : 'hover:bg-[#1C1D20]'
              }`}>
                <Building2Icon className="text-white" />
